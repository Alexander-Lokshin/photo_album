...
export default function AlbumsForm({setCurrentAlbums}) {
  ...
  return (
   ...
   <Form.Group className="mb-3" controlId="formBasicEmail">
     ...
     <Form.Control  value={formData.title} type="text" name="title" placeholder="Название альбома" autoComplete="off" onChange={changeAlbumHandler} />
   </Form.Group>
   <Form.Select aria-label="Default select example" name="isOpen" onChange={changeAlbumHandler}>
